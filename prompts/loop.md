...
0. **Greenlight check (do this before every iteration):** read only `greenlight/CONTROL.md` front-matter. If `greenlight: "yes"`, do NO work and run NO further tools; reply with exactly: "GREENLIGHT ACHIEVED — the app is finished. Stop the loop and review your app." Then stop.
